...
function Post() {
  ...
  useEffect(() => {
    axios
      .get(`https://musiquesaur.herokuapp.com/posts/byId/${id}`)
      .then((response) => {
        setPostObject(response.data);
      });

    axios
      .get(`https://musiquesaur.herokuapp.com/comments/${id}`)
      .then((response) => {
  ...
  const addComment = () => {
    axios
      .post(
        "https://musiquesaur.herokuapp.com/comments",
        {
  ...
  const deleteComment = (id) => {
    axios
      .delete(`https://musiquesaur.herokuapp.com/comments/${id}`, {
  ...
  const deletePost = (id) => {
    axios
      .delete(`https://musiquesaur.herokuapp.com/posts/${id}`, {
        headers: { accessToken: localStorage.getItem("accessToken") },
      })
      .then(() => {
        history.push("/");
  ...
  const editPost = (option) => {
    if (option === "title") {
      ...
      axios.put(
        "https://musiquesaur.herokuapp.com/posts/title",
        {
          newTitle: newTitle,
          id: id,
        },
      ...
      axios.put(
        "https://musiquesaur.herokuapp.com/posts/postText",
        {
          newText: newPostText,
          id: id,
        },
