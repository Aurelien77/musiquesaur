...
function Post2() {
  ...
  useEffect(() => {
    axios
      .get(`https://musiquesaur.herokuapp.com/postspriv/byId/${id}`)
      .then((response) => {
        setPostObject(response.data);
      });

    axios
      .get(`https://musiquesaur.herokuapp.com/comments2/${id}`)
      .then((response) => {
  ...
  const addComment = () => {
    axios
      .post(
        "https://musiquesaur.herokuapp.com/comments2",
        {
  ...
  const deleteComment = (id) => {
    axios
      .delete(`https://musiquesaur.herokuapp.com/comments2/${id}`, {
  ...
  const deletePost = (id) => {
    axios
      .delete(`https://musiquesaur.herokuapp.com/postspriv/${id}`, {
        headers: { accessToken: localStorage.getItem("accessToken") },
      })
      .then(() => {
        history.push("/");
  ...
  const editPost = (option) => {
    if (option === "title") {
      ...
      axios.put(
        "https://musiquesaur.herokuapp.com/postspriv/title",
        {
          newTitle: newTitle,
          id: id,
        },
      ...
      axios.put(
        "https://musiquesaur.herokuapp.com/postspriv/postText",
        {
          newText: newPostText,
          id: id,
        },
