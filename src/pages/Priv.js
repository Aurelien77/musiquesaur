...
function Profile() {
  ...
  useEffect(() => {
    axios
      .get(`https://musiquesaur.herokuapp.com/auth/postspriv/${id}`)
      .then((response) => {
    ...
    axios
      .get(`https://musiquesaur.herokuapp.com/postspriv/byuserId/${id}`)
      .then((response) => {
          ...
          <div className="basicinfo3">
            ...
            {(authState.username === username || authState.admin === true) && (
              <>
                ...
                <form
                  action={"https://musiquesaur.herokuapp.com/upload/" + id}
                  method="POST"
